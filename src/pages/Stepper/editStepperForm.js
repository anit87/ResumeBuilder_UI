...
import { UserIntakeFormUpdate, UserIntakeFormById } from '../../redux/action/Action';
import CheckCircleOutlineIcon from '@mui/icons-material/CheckCircleOutline';
import { useNavigate, useParams } from 'react-router-dom';

import { Paper, Box, Button, Typography, TextField, Alert } from '@mui/material';
...
const EditSteppers = () => {
  ...
  const IntakeSubmitMessage = useSelector((state) => state.GetUserIntakeFormUpdated.getUserStepFormUpdatedmsg);
  ...
  const handleSave = (data) => {
    if (data == 'save') {
      //   dispatch(UserIntakeFormUpdate(getInputData)).then(() => navigate(-1))
      dispatch(UserIntakeFormUpdate(getInputData))
  ...
  useEffect(() => {
    let DataTime = setTimeout(() => {
      SetGetInputData({
        name: GetIntakeFrmDataId[0].stepfrm_name,
        lName: GetIntakeFrmDataId[0].stepfrm_lName,
        order_id: GetIntakeFrmDataId[0].order_number,
        email: GetIntakeFrmDataId[0].stepfrm_email,
        address: GetIntakeFrmDataId[0].stepfrm_address,
        appartment: GetIntakeFrmDataId[0].stepfrm_appartment,
        city: GetIntakeFrmDataId[0].stepfrm_city,
        postal_code: GetIntakeFrmDataId[0].stepfrm_postal_code,
        country: GetIntakeFrmDataId[0].stepfrm_country,
        phone: GetIntakeFrmDataId[0].stepfrm_phone,
        linkeDin: GetIntakeFrmDataId[0].stepfrm_linkeDin,
        institude: GetIntakeFrmDataId[0].stepfrm_institute,
        location: GetIntakeFrmDataId[0].stepfrm_location,
        degree: GetIntakeFrmDataId[0].stepfrm_degree,
        concentration: GetIntakeFrmDataId[0].stepfrm_concentration,
        startDate: GetIntakeFrmDataId[0].stepfrm_start_date,
        toEnd: GetIntakeFrmDataId[0].stepfrm_toend_date,
        graduation: GetIntakeFrmDataId[0].stepfrm_graduation,
        graduation_date: GetIntakeFrmDataId[0].stepfrm_graduation == "Yes" ? GetIntakeFrmDataId[0].stepfrm_graduation_date : "0000-00-00",
        company_name: GetIntakeFrmDataId[0].stepfrm_company_name,
        company_address: GetIntakeFrmDataId[0].stepfrm_company_address,
        date_of_form: GetIntakeFrmDataId[0].stepfrm_date_of_form,
        ToEmployment: GetIntakeFrmDataId[0].stepfrm_toemployment,
        job_title: GetIntakeFrmDataId[0].stepfrm_job_title,
        direct_report: GetIntakeFrmDataId[0].stepfrm_direct_report,
        description: GetIntakeFrmDataId[0].stepfrm_description,
        techinical_skill: GetIntakeFrmDataId[0].stepfrm_techinical_skill,
        other_info: GetIntakeFrmDataId[0].stepfrm_other_info
      })
      ...
      <>
        <div className={animation ? "row animated bounceInRight" : "row animated bounceInLeft"}>
          ...
          <div className="mb-3  col-sm-12 col-md-6 col-lg-6 col-xl-6">
            ...
            <input type="text" className="form-control" id="exampleFormControlInput" name='email' value={getInputData.email} onChange={(e) => handleStepperForm(e)} />
          </div>
        </div>
        ...
        <button className="btn stepper_save me-3" type="submit" onClick={() => handleSave('save')}>
          Save<FiSave size={20} className='stepIcon' /> </button>
      </>
    )
  }
  const Address = () => {
      ...
      <>
        <div className={animation ? "row animated bounceInRight" : "row animated bounceInLeft"}>
          ...
          <div className="mb-4  col-sm-12 col-md-6 col-lg-6 col-xl-6">
            ...
            <input type="text" className="form-control" id="exampleFormControlInput1" placeholder="Last Name" name='appartment' value={getInputData.appartment} onChange={(e) => handleStepperForm(e)} />
          </div>
          <div className="mb-4 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        ...
        <div className={animation ? "row animated bounceInRight" : "row animated bounceInLeft"}>
          ...
          <div className="mb-4  col-sm-12 col-md-6 col-lg-6 col-xl-6">
            ...
            <input type="Date" className="form-control" id="exampleFormControlInput1" placeholder="Graduation Date" name='graduation_date'
              value={getInputData.graduation == 'Yes' ? getInputData.graduation_date : getInputData.graduation == 'No' ? "0000-00-00" : "0000-00-00"} onChange={(e) => handleStepperForm(e)} disabled={getInputData.graduation === "Yes" ? 0 : 1} />
          </div>
        </div>
        <button className="btn stepper_back  me-3" type="submit" onClick={() => handleNavigate('prev')}><HiOutlineArrowNarrowLeft size={20} className='stepIcon' /> Back</button>
        <button className="btn stepper_next me-3" type="submit" onClick={() => handleNavigate('next')}>Next <HiOutlineArrowNarrowRight size={20} className='stepIcon' /></button>
    ...
    return (
      <>
        <div className={animation ? "row animated bounceInRight" : "row animated bounceInLeft"}>
          ...
          <div className="mb-4 col-sm-12 col-md-6 col-lg-6 col-xl-6">
            <label htmlFor="exampleFormControlInput1" className="form-label">Dates of Employment: Form</label>
          ...
          <div className="mb-4  col-sm-12 col-md-6 col-lg-6 col-xl-6">
            ...
            {/* <input type="Date" className="form-control" id="exampleFormControlInput1" placeholder="End Date" name='direct_report' value={getInputData.direct_report} onChange={(e) => handleStepperForm(e)} /> */}
          </div>
          <div className="mb-4 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <label htmlFor="exampleFormControlTextarea1" className="form-label">Description of duties and achievements</label>
            {/* <textarea className="form-control" id="exampleFormControlTextarea1" rows="4" name='description' value={getInputData.description} onChange={(e) => handleStepperForm(e)}></textarea> */}
      ...
      <>
        <div className={animation ? "row animated bounceInRight" : "row animated bounceInLeft"}>
          <div className="mb-4 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            {/* <textarea className="form-control" id="exampleFormControlTextarea1" rows="15" cols='4' placeholder='Technical Skills' name='techinical_skill' value={getInputData.techinical_skill} onChange={(e) => handleStepperForm(e)} /> */}
            <div className='achievements'>
      ...
      <>
        <div className={animation ? "row animated bounceInRight" : "row animated bounceInLeft"}>
          <div className="mb-4 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            {/* <textarea className="form-control" id="exampleFormControlTextarea1" rows="15" cols='3' placeholder='Any other infomation you would like to include?' name='other_info' value={getInputData.other_info} onChange={(e) => handleStepperForm(e)} ></textarea> */}
            <div className='achievements'>
    ...
    return (
      <>
        ...
        {steps[steps.length - 1].id === newState && <button className="btn stepper_save me-3" type="submit" onClick={() => handleSave('save')}>
          Update<FiSave size={20} className='stepIcon' /> </button>}
  ...
  return (
    <Layout>
      <div className='padding_div hiding_mininav_stepper'>
        {/* <MiniNav NavData={['stepperform','IntakeForm']} /> */}
